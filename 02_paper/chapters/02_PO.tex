...
The cCACE is a straightforward extension of the CACE in \ref{defn:CACE} with \cite{bargagli-stoffi_heterogeneous_2022} providing theorems of a consistent and asymptotic normal conditional Two-Stage-Least-Square (2SLS) estimator which rely on the unconditional theorems of Wooldridge with the additional assumption of sufficient number of observations for every subgroup in which the cCACE is estimated.