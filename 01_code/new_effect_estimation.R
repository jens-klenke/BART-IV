...
# load stan models ----
stan_model_first_stage <- readRDS(here::here("05_stan_code/brms_first_stage_4000.rds"))
stan_model_second_stage <- readRDS(here::here("05_stan_code/brms_second_stage_4000.rds"))
