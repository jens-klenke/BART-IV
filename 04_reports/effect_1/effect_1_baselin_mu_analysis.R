...
load(url('https://uni-duisburg-essen.sciebo.de/s/Lh9snJT6Saz2G1T/download'))
...
binary_results %>%
  ...
  geom_vline(data = get_vline(binary_results, 1), aes(xintercept = x_line), color = '#004c93', linewidth = 0.75, linetype = 'longdash')
